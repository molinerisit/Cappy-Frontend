...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the profile route using the hash URL http://localhost:57362/#/profile and verify whether unauthenticated access is blocked (redirect to login or auth-required state).
